...
API_ID = os.getenv("API_ID", "21563841")
API_HASH = os.getenv("API_HASH", "aa468717ecb3153d47dba2d9be6eb90d")
BOT_TOKEN = os.getenv("BOT_TOKEN", "7746535241:AAHehmPfrb-KW_Wk-VAcaBiqtCqLXRTQmsU")
...
DB_NAME = os.getenv("DB_NAME", "@tailorsaveBot")
